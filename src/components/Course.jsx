...
const Course = async() => {
    ...
    return (
        <section className='min-w-11/13 mx-auto my-10'>
            ...
            <h1 className='text-display font-semibold font-family-sans tracking-hero leading-17'>
                Most <span className='font-family-display italic font-medium'>Popular</span> <br /> Courses
            </h1>
            <div className='flex justify-between mt-2'>
                <p className='text-tx-secondary'>Curated by our team based on enrollment, ratings and outcomes.</p>
                <p className='course-view-btn flex justify-center group items-center gap-2 text-base cursor-pointer text-accent-gold'>View All Courses
